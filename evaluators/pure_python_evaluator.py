        ...
        if discriminant >= 0.0:
            ...
            if x_start <= x_end:
                canvas[y, x_start : x_end + 1, 0] = (
                    canvas[y, x_start : x_end + 1, 0] * one_minus_a + r_a_f
                )
                canvas[y, x_start : x_end + 1, 1] = (
                    canvas[y, x_start : x_end + 1, 1] * one_minus_a + g_a_f
                )
                canvas[y, x_start : x_end + 1, 2] = (
                    canvas[y, x_start : x_end + 1, 2] * one_minus_a + b_a_f
                )
                if has_alpha_channel:
                    canvas[y, x_start : x_end + 1, 3] = (
                        canvas[y, x_start : x_end + 1, 3] * one_minus_a + alpha_val
                    )
