...
# ----------------------------------------------------------------------
REFERENCE_MSE = {
    "Geometric": {"Tier_1": 274.0875, "Tier_2": 84.1177, "Tier_3": 84.1177},
    "Gradient": {"Tier_1": 146.7333, "Tier_2": 127.2739, "Tier_3": 127.2739},
    "High_Frequency": {"Tier_1": 3516.4910, "Tier_2": 3225.6494, "Tier_3": 3225.6494},
    "Alpha_Mask": {"Tier_1": 216.7076, "Tier_2": 87.5293, "Tier_3": 87.5293},
}

# ----------------------------------------------------------------------
# 標準參考機性能定義 (Ryzen 5600X + RTX 3060)
# ----------------------------------------------------------------------
BASELINE_REFERENCE = {"Tier_1": 2500.0, "Tier_2": 450.0, "Tier_3": 8.5}
...
def load_profile_params(profile_path, default_batch, default_steps):
    ...
    if profile_path and os.path.exists(profile_path):
        try:
            ...
            print(
                f"[Warning] Failed to parse profile {os.path.basename(profile_path)}: {e}"
            )
