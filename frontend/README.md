...
This is the Tauri and Vanilla HTML/CSS/JS frontend for FH6-Painter. It provides a real-time canvas preview of geometry fitting, live HUD metrics, interactive Region of Interest (ROI) painting, a Text Vinyl Generator, a Performance Benchmark Console, and History Rewind capabilities for generating Forza Horizon 6 liveries.
